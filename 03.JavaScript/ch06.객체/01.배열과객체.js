...
let fruitObject = {0:'감', 1:'귤', 2:'밤', 3:'배'}; //올바른 사용 아님
console.log(fruitArray[0], fruitObject[1]);

// 객체(Object) - 자료구조로서 객체는 파이썬의 딕셔너리, 자바의 맵과 유사함
// key - value 쌍
let personArray = ['James', 27, '남자','프로그래머', 175.3]
let personObject= {name:'James', age:27, gender:'남자',job:'프로그래머',heigth: 175.3};
console.log(personInfo);
let car = {manufacturer:'현대자동차', model:'casper',color:'카키색'}  // key를 문자열로 써도 무방하다.
console.log(car);
