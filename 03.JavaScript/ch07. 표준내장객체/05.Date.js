...
// 1. 현재 날짜/시간
let today = new Date();
console.log (today);                    //2024-01-08T04:48:58.622Z
console.log (today.toISOString());      //2024-01-08T04:48:58.622Z
console.log (today.toLocaleString());   //2024. 1. 8. 오후 1:48:58 Timezone 반영
...
let unixDay = new Date(1.7047e12);
console.log(myDateTime(unixDay))
console.log(new Date('2024-01-07 14:00:00').getTime());
...
date.setMonth(date.getMonth() + 6);      // 오늘부터 6개월 후
date.setFullYear(date.getFullYear() + 1);       // 1 년후
console.log(myDateTime(date));

// console.log(myDateTime(today.setDate(today.getDate() + 100)));      // 오늘부터 100일후
// console.log(myDateTime(today.setDate() - 100));      
